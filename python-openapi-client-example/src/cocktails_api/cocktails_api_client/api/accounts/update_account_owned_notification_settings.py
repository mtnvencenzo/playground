...
from ...models.update_account_owned_notification_settings_rq import UpdateAccountOwnedNotificationSettingsRq
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: UpdateAccountOwnedNotificationSettingsRq,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/accounts/owned/profile/notifications",
    }
...
def sync_detailed(
    *,
    ...
    """Updates the account profile notifications settings for the user represented within the authenticated
    bearer token
