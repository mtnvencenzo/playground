...
T = TypeVar("T", bound="AccountNotificationSettingsModel")


@_attrs_define
class AccountNotificationSettingsModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_notification_settings_model = cls(
            on_new_cocktail_additions=on_new_cocktail_additions,
        )

        account_notification_settings_model.additional_properties = d
        return account_notification_settings_model
