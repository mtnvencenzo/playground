...
T = TypeVar("T", bound="CocktailRatingModel")


@_attrs_define
class CocktailRatingModel:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cocktail_rating_model.additional_properties = d
        return cocktail_rating_model
