...
T = TypeVar("T", bound="AccountCocktailRatingsRs")


@_attrs_define
class AccountCocktailRatingsRs:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_cocktail_ratings_rs = cls(
            ratings=ratings,
        )

        account_cocktail_ratings_rs.additional_properties = d
        return account_cocktail_ratings_rs
