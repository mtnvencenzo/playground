...
from ...models.cocktail_recommendation_rq import CocktailRecommendationRq
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/accounts/owned/profile/cocktails/recommendations",
    }
