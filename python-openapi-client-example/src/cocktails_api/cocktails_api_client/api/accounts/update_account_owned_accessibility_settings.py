...
from ...models.update_account_owned_accessibility_settings_rq import UpdateAccountOwnedAccessibilitySettingsRq
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: UpdateAccountOwnedAccessibilitySettingsRq,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/accounts/owned/profile/accessibility",
    }
...
def sync_detailed(
    *,
    ...
    """Updates the account profile accessibility settings for the user represented within the authenticated
    bearer token
