...
from ...models.manage_favorite_cocktails_rq import ManageFavoriteCocktailsRq
...
def _get_kwargs(
    *,
    body: ManageFavoriteCocktailsRq,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/api/v1/accounts/owned/profile/cocktails/favorites",
    }
...
def sync_detailed(
    *,
    ...
    """Manages the account profile favorite cocktails list for the user represented within the
